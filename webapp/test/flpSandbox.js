					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Binding Aggregation",
									"targetURL": "#moovim06a04-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"moovim06a04-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=moovi.m06a04",
									"url": sap.ui.require.toUrl("moovi/m06a04")
								}
							}
						}
					}
